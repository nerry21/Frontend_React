// src/pages/FinancialReports/components/TripTable.jsx

import React from 'react';
import { motion } from 'framer-motion';
import { Button } from '@/components/ui/button';
import { Edit, Trash2 } from 'lucide-react';
import { formatPct, rupiah } from '../utils';
import { getMonthName } from '../utils';

export default function TripTable({ paginated, onEdit, onDelete, MONTHS_ID }) {
  return (
          ...
          <tbody className="divide-y divide-slate-800 text-gray-200">
            {paginated.map((t, i) => (
              ...
              >
                <td className="p-3 sticky left-0 bg-slate-900/80 backdrop-blur z-10">
                  <div className="flex gap-2">
                    ...
                    <Button
                      size="icon"
                      variant="ghost"
                      className="h-7 w-7 text-rose-300 hover:bg-rose-500/10"
                ...
                <td className="p-3">{getMonthName(t.month, MONTHS_ID)}</td>
                ...
                <td className="p-3">{formatPct(t.calc_deptAdminPercent)}%</td>
                ...
                <td className="p-3">{formatPct(t.calc_retAdminPercent)}%</td>
