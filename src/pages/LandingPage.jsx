...
const ServiceCard = ({
  ...
  features,
  index,
  onBook, // ⬅️ handler klik Book Now
}) => {
  return (
    <motion.div 
...
const LandingPage = () => {
  ...
  // ⬇️ onBook untuk tiap layanan → arahkan ke BookingPage dengan query category
  const transportServices = [
    {
      ...
      onBook: () => navigate('/booking?category=Reguler'),
    },
    {
      icon: MapPin,
      ...
      onBook: () => navigate('/booking?category=Dropping'),
    },
    {
      icon: Car,
      ...
      onBook: () => navigate('/booking?category=Rental'),
    },
    {
      icon: Package,
      title: "Paket Barang",
      ...
      onBook: () => navigate('/booking?category=Paket Barang'),
    },
  ];
